...
class nnUNetTrainerDropout_p4(nnUNetTrainer): #Define custom class and inherit from nnUnetTrainer class    
    ...
    def get_training_transforms( 
        ...
        # Dropout Transform
        transforms.append(RandomTransform(
        MissingModalityTransform_perImage(probability=0.04), apply_probability=1.0
        ))
