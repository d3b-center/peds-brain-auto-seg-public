...
from batchgeneratorsv2.transforms.custom.missing_modality_transform_per_image_full import MissingModalityTransform_perImage_full
...
class nnUNetTrainerDropout_full_p40(nnUNetTrainer): #Define custom class and inherit from nnUnetTrainer class    
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            for batch_id in range(self.num_iterations_per_epoch):
                ...
                for img_idx in range(batch_size):
                    ...
                    ch2_is_zero = ch2_min == 0 and ch2_max == 0
                    ch3_is_zero = ch3_min == 0 and ch3_max == 0
            ...
            print(f"Channel 2 was zeroed in {ch2_zero_count} / {total_images} images ({(ch2_zero_count / total_images) * 100:.2f}%)")
            print(f"Channel 3 was zeroed in {ch3_zero_count} / {total_images} images ({(ch3_zero_count / total_images) * 100:.2f}%)")
    ...
    def get_training_transforms( 
        ...
        # Dropout Transform
        transforms.append(RandomTransform(
        MissingModalityTransform_perImage_full(probability=0.4), apply_probability=1.0
        ))
