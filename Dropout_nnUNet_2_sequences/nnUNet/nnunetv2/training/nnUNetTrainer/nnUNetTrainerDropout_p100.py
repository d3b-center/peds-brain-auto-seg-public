...
class nnUNetTrainerDropout_p100(nnUNetTrainer): #Define custom class and inherit from nnUnetTrainer class    
    ...
    def get_training_transforms( 
        ...
        # Dropout Transform
        transforms.append(RandomTransform(
        MissingModalityTransform_perImage(probability=1.0), apply_probability=1.0
        ))
