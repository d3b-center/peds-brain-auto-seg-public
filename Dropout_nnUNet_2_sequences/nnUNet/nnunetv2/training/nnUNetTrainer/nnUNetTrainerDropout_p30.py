...
class nnUNetTrainerDropout_p30(nnUNetTrainer): #Define custom class and inherit from nnUnetTrainer class    
    ...
    def get_training_transforms( 
        ...
        # Dropout Transform
        transforms.append(RandomTransform(
        MissingModalityTransform_perImage(probability=0.3), apply_probability=1.0
        ))
